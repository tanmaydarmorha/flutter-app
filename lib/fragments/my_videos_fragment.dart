...
class MyVideosFragment extends StatefulWidget {
  @override
  _MyVideosFragmentState createState() => _MyVideosFragmentState();
}

class _MyVideosFragmentState extends State<MyVideosFragment> {
  List<Folder> folders;
  String snackBarMessage;

  getFolderList() async {
    NetworkHelper networkHelper = NetworkHelper(
        url: 'https://api.fluvid.com/api/v1/folders/?limit=50&page=1');
    ...
    return Padding(
      ...
      child: CustomScrollView(
        slivers: <Widget>[
                                  ...
                                  switch (response) {
                                    case 'addToFav':
                                      if (await UpdateService
                                        ...
                                        snackBarMessage = 'Could Not Update';
                                      }
                                      Scaffold.of(context)
          ...
          VideosList(
            videosUrl:
                'https://api.fluvid.com/api/v1/videos/my?limit=50&page=1',
            currentScreen: Screens.MyVideos,
          ),
        ],
      ),
    );
